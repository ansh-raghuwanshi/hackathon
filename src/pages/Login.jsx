    ...
    <div className="auth-page">
      <div className="auth-card">
        <div className="auth-header">
          ...
          <h2>Welcome back</h2>
          <p>Sign in to your SnapFix account</p>
        </div>
        ...
        {/* Google */}
        <button onClick={handleGoogleLogin} disabled={loading} className="btn-google" id="google-login-btn">
        ...
        <form onSubmit={handleEmailLogin} id="email-login-form">
          <div className="form-group">
            <label className="form-label" htmlFor="login-email">
              <Mail size={12} style={{ display: 'inline', marginRight: 4 }} />Email
            </label>
            <input id="login-email" type="email" className="form-input" placeholder="admin@civicsync.gov"
